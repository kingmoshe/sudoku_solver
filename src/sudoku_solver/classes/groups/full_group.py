        ...
        for first_digit in good_digits:
            for second_digit in good_digits:
                if second_digit <= first_digit:
                    continue
                good_cells = [cell for cell in self.cells if first_digit in cell.digits and second_digit in cell.digits]
                if len(good_cells) == 2:
                    for cell in good_cells:
                        bad_digits = {dig for dig in cell.digits if dig not in [first_digit, second_digit]}
